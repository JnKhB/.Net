        ...
        public async Task<AccelerationGameModel> LoadAsync(String path)
        {
            ...
            try
            {
                using (StreamReader reader = new StreamReader(path))
                {
                    ...
                    AccelerationGameModel model = new AccelerationGameModel(panelCoordinates, coordinates, dimensions);
                    ...
                    //model.m_motorCycle.m_coordinates.m_x = Int32.Parse(numbers[0]);
                    //model.m_motorCycle.m_coordinates.m_y = Int32.Parse(numbers[1]);
