...
namespace Acceleration.model
{
    ...
    public class AccelerationGameModel
    {
        ...
        public int m_time;
        public Timer m_timerOfMoving;
        public Timer m_timer; 
        public Timer m_ticker;
        public Timer m_accelerationTime;
        ...
        */
        ...
        public async Task LoadGameAsync(String path)
        {
            ...
            On_RefreshTimeAndPetrol();
            Debug.WriteLine(m_motorCycle.m_coordinates.m_x);
            Debug.WriteLine(m_motorCycle.m_coordinates.m_y);
            On_RefreshMotorPosition();
        }
    }
}
